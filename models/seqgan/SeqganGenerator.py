...
class Generator(Gen):
    def __init__(self, num_vocabulary, batch_size, emb_dim, hidden_dim,
        ...
        self.one_hot_value = tf.one_hot(tf.to_int32(tf.reshape(self.x, [-1])), self.num_vocabulary, 1.0,
                                        0.0) * tf.reshape(self.g_predictions, [-1, self.num_vocabulary])
        self.ppl_slipt = self.one_hot_value[:, :self.num_vocabulary - 1]
